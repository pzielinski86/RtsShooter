...
namespace Game.Core
{
    public class WorldMap : IWorldMap
    {
        ...
        public WorldMap(IInput input, IPhysics physics)
        {
            ...
            Enemies = new ObservableCollection<INpc>();
            Enemies.ItemRemoved += Enemies_ItemRemoved;
        }

        private void Enemies_ItemRemoved(object sender, ObservableCollectionEventArgs<INpc> e)
        {
            e.Item.Destroy();
        }
        ...
        public ObservableCollection<INpc> Enemies { get; private set; }
        public BulletsHandler BulletsHandler { get; private set; }
        public NpcAttacksManager NpcAttacksManager { get; set; }

        public INpc InitNpc(CharacterTransform characterTransform, INpcController npcController)
        {
